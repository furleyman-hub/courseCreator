...
1. Ensure the backend is running (default `http://localhost:8000`). Set `BACKEND_URL` in your environment or Streamlit secrets to prefill a different base URL in the sidebar.
