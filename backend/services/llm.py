...
def generate_class_outline(text: str, course_title: str, api_key: Optional[str] = None) -> ClassOutline:
...
def generate_instructor_guide(text: str, course_title: str, api_key: Optional[str] = None) -> InstructorGuide:
...
def generate_video_script(text: str, course_title: str, api_key: Optional[str] = None) -> VideoScript:
...
def generate_quick_reference(text: str, course_title: str, api_key: Optional[str] = None) -> QuickReferenceGuide:
